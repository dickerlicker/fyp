...
CREATE TABLE `passengerdetails` (
  ...
  CONSTRAINT `bookingID` FOREIGN KEY (`bookingID`) REFERENCES `booking` (`bookingID`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `passengerdetails` VALUES (10,NULL,'Tan','1235675','tan@gmail.com',12345612),(15,NULL,'a','127398172','a@a.com',12346521),(14,NULL,'a','a','a@a.com',12356784),(8,NULL,'as','as','a@a.com',12356784),(13,NULL,'asd','asd','a@a.com',12345612),(15,NULL,'a','asdasxz1','a@a.com',1231231),(15,NULL,'asdasd','sad123sad','a@a.com',12312312);
